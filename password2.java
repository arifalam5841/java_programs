...
public class password2 {
    public static void main(String[] args) {
        main_func password = new main_func("trongssword123");

        System.out.println("Password: " + password);
        System.out.println("Strength Score: " + password.PasswordStrength());
        System.out.println("Feedback: " + password.calculateScore());
    }
}